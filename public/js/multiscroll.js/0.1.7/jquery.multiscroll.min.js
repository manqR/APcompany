...
! function(e, t, n, o, i) {
    e.fn.multiscroll = function(s) {
        ...
        function m() {
            s.css3 ? (v(e(".ms-left"), "translate3d(0px, -" + e(".ms-left").find(".ms-section.active").position().top + "px, 0px)", !1), v(e(".ms-right"), "translate3d(0px, -" + e(".ms-right").find(".ms-section.active").position().top + "px, 0px)", !1)) : (e(".ms-left").css("top", -e(".ms-left").find(".ms-section.active").position().top), e(".ms-right").css("top", -e(".ms-right").find(".ms-section.active").position().top))
        }
        ...
        if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
            ...
            function f(t) {
                ...
                if (o.addClass("active").siblings().removeClass("active"), t.addClass("active").siblings().removeClass("active"), x(i), s.css3) {
                    ...
                    v(e(".ms-left"), m, !0), v(e(".ms-right"), f, !0), setTimeout(function() {
        ...
        function h(e) {
            ...
            return q || (n < 0 ? B.moveSectionDown() : B.moveSectionUp()), !1
        }
